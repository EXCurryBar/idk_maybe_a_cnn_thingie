...
network.add(layers.Conv1D(75,5,activation='relu',padding='same',input_shape=(75,1)))
network.add(layers.BatchNormalization())
network.add(layers.Conv1D(75,5,activation='relu',padding='same'))
...
network.fit(trn_data, trn_labels, epochs=500, batch_size=10)
network.save('123.h5')
